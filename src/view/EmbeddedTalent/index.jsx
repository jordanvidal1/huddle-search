...
import InfoIcon1 from '../../embedded-icon-1.svg';
import InfoIcon2 from '../../embedded-icon-2.svg';
import InfoIcon3 from '../../embedded-icon-3.svg';
import InfoIcon4 from '../../embedded-icon-4.svg';
import './styles.scss';
