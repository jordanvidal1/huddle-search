...
const {constant, prop, flatten} = require('./fn');
...
const AsyncDataSome = asyncDataList => someSuccess(asyncDataList)
  ? AsyncData.Success()
  : AsyncData.Loading();

// AsyncData[] -> AsyncData
// if all success return success
const AsyncDataAll = asyncDataList => allSuccess(asyncDataList)
